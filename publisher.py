#Kaynak asagidaki linktedir:
#https://github.com/SiChiTong/autonomous_bicycle/blob/master/src/sensor_imu_publisher.py
#!/usr/bin/env python
...
class RobotImuPublisherNode:
    def __init__(self):
        ...
        self.rate = rospy.get_param('~rate', 200.0)  # the rate at which to publish the transform
